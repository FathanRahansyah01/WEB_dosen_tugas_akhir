...
<div class="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-indigo-50 via-white to-purple-50">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-1">Buat akun dosen baru</p>
        </div>

        {{-- Card --}}
        <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8">
            <h3 class="text-xl font-semibold text-gray-900 mb-6">Registrasi</h3>

            @if($errors->any())
                <div class="mb-4 bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-lg text-sm" id="register-error">
            ...
            <form method="POST" action="/register" id="register-form">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="toggle-password-confirm" onclick="togglePassword('password_confirmation')"
                                class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-600 transition-colors">
        ...
        <p class="text-center mt-6 text-sm text-gray-600">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="text-indigo-600 hover:text-indigo-700 font-medium transition-colors" id="link-login">
                Masuk di sini
            </a>
        </p>
    </div>
